...
@section('admin-content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="{{ route('admin.pages.edit', $pages->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" class="form-control" name="page_name"
                                        value="{{ $pages->page_name }}" required>
                                    @error('page_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="short_description" rows="4">{{ $pages->short_description }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="ckeditor" class="form-control" name="description" rows="4" required>{{ $pages->description }}</textarea>
                                    @error('description')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ ucwords($message) }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputStatus" name="status" class="form-control custom-select" required>
                                        ...
                                        <option value="1"{{ $pages->status == 1 ? 'selected' : '' }}>Publish
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputStatus" name="viewby" class="form-control custom-select" required>
                                        <option value="1" {{ $pages->viewby == 1 ? 'selected' : '' }}>Header</option>
                                        <option value="0" {{ $pages->viewby == 0 ? 'selected' : '' }}>Footer</option>
                                        <option value="2" {{ $pages->viewby == 2 ? 'selected' : '' }}>Both</option>
                                        <option value="3" {{ $pages->viewby == 3 ? 'selected' : '' }}>None</option>
                                    </select>
                                    @error('viewby')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ ucwords($message) }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputEstimatedDuration" class="form-control"
                                        value="{{ $pages->sort }}" name="sort" step="0.1">
                                    @error('sort')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ ucwords($message) }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputEstimatedDuration" class="form-control"
                                        value="{{ $pages->link }}" name="link" step="0.1">
                                    @error('link')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ ucwords($message) }}</strong>
                                        </span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" name="meta_title"
                                        value="{{ $pages->meta_title }}" class="form-control">
                                    @error('meta_title')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ ucwords($message) }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" name="meta_keyword"
                                        value="{{ $pages->meta_keywords }}" class="form-control">
                                    @error('meta_keyword')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ ucwords($message) }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="inputDescription" name="meta_description" class="form-control" rows="4">{{ $pages->meta_description }}</textarea>
