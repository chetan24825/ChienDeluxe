                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select id="colors" name="colors[]" required
                                            class="select2 form-control custom-select" multiple
                                            {{ count(json_decode($product->colors)) > 0 ? '' : 'disabled' }}>

                                            @foreach (App\Models\Color::orderBy('name', 'asc')->get() as $color)
                                                <option value="{{ $color->code }}"
                                                    @if ($product->colors != null && in_array($color->code, json_decode($product->colors, true))) selected @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select id="choice_attributes" name="choice_attributes[]"
                                            data-selected-text-format="count" class="select2 form-control custom-select"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-3">
                                                ...
                                                <input type="text" class="form-control" name="choice[]"
                                                    value="{{ App\Models\AttributeVariable::find($choice_option->attribute_id)->name }}"
