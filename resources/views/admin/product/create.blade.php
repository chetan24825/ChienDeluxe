...
@section('admin-content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="{{ route('admin.product') }}" method="POST" novalidate enctype="multipart/form-data"
                id="choice_form">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="attribute_id">Attribute Collection <span class="text-danger">*</span></label>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="signinSrEmail">Select The Main Image <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputDescription">Product Description<span class="text-danger">*</span></label>
                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="inputEstimatedBudget">Market Price (MRP) <span class="text-danger">*</span></label>
                                                <input type="number" id="mrp" name="market_price"
                                                    class="form-control" value="{{ old('market_price') }}"
                                                    step="1" required>
                                                @error('market_price')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ ucwords($message) }}</strong>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="inputSpentBudget">Purchase Cost<span class="text-danger">*</span></label>
                                                <input type="number" id="purchase" name="purchase_cost"
                                                    class="form-control" value="{{ old('purchase_cost') }}"
                                                    step="1" required>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="inputEstimatedDuration">GST <small
                                                        class="text-danger">(%)</small><span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="netcost" name="net_cost"
                                                    class="form-control" value="{{ old('net_cost') }}" step="0.1"
                                                    required>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="saleprice" name="sale_price"
                                                    class="form-control" value="{{ old('sale_price') }}" step="0.1"
                                                    required>
                                                @error('sale_price')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ ucwords($message) }}</strong>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="inputEstimatedDuration">Stock<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="inputStatus">Stock Status<span class="text-danger">*</span></label>
                                                <select id="inputStatus" name="in_stock"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <label class="aiz-switch aiz-switch-success mb-0">
                                                <input value="1" id="variaction" type="checkbox"
                                                    name="colors_active">
                                                <span></span>
                                            </label>
                                        </div>
